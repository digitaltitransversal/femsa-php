 ...
 *
 * @category Class
 * @description [Shipping Contacts](https://developers.femsa.com/v2.2.0/reference/createcustomershippingcontacts) details for updating a customer shipping contact. Only the fields provided in the request body are updated.
 * @package  DigitalFemsa
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
    ...
    */
    ...
    public function setMetadata($metadata)
    {
        ...
        if ((count($metadata) > 100)) {
            throw new \InvalidArgumentException('invalid value for $metadata when calling CustomerUpdateShippingContacts., number of items must be less than or equal to 100.');
        }
